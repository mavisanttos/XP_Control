      ...
      <div className="w-full px-4 py-6 md:py-8 max-w-6xl mx-auto pb-24 md:pb-8">
        ...
        <div className="mb-6 md:mb-8">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-sm font-semibold text-slate-400">Progresso</h2>
          ...
          <p className="text-xs text-slate-500 mt-1">1250 / 2000 XP</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="premium-card">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <p className="text-slate-400 text-xs md:text-sm">Saldo Global</p>
            ...
            <p className="text-xs text-slate-500">Contas conectadas via Open Finance</p>
          </div>
          ...
          <div className="premium-card">
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <p className="text-slate-400 text-xs md:text-sm">XP Coins</p>
            ...
            <p className="text-xs text-slate-500">Moeda do jogo - Use em missões</p>
          </div>
        </div>
        ...
        <div className="premium-card border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-slate-950 mb-6">
          ...
          <p className="text-slate-300 mb-4 text-sm md:text-base">Otimize seus recursos para ganhar bônus especiais</p>
          <button
